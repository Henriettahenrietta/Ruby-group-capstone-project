  ...
  module Protocol
    module Constant
      module ErrorCodes
        ...
        #
        JSONRPC_RESERVED_ERROR_RANGE_START = -32_099
        ...
        #
        JSONRPC_RESERVED_ERROR_RANGE_END = -32_000
        SERVER_ERROR_END = JSONRPC_RESERVED_ERROR_RANGE_END
        #
        # This is the start range of LSP reserved error codes.
        # It doesn't denote a real error code.
        #
        LSP_RESERVED_ERROR_RANGE_START = -32_899
        #
        ...
        # It doesn't denote a real error code.
        #
        LSP_RESERVED_ERROR_RANGE_END = -32_800
      end
    end
  end
end
